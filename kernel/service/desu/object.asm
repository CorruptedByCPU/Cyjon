...
.insert:
	...
	; poinformuj środowisko GUI o zmianie ilości okien

	; ; pobierz PID arbitra
	; mov	rbx,	qword [service_desu_object_privileged_pid]
	;
	; ; skomponuj komunikat dla procesu
	; mov	rsi,	service_desu_message
	;
	; ; wyślij informacje o typie informacji
	; mov	byte [rsi + SERVICE_DESU_STRUCTURE_MESSAGE.type],	SERVICE_DESU_MESSAGE_TYPE_WINDOW_new
	;
	; ; nie przesyłamy innych danych
	; mov	qword [rsi + SERVICE_DESU_STRUCTURE_MESSAGE.id],	STATIC_EMPTY
	; mov	qword [rsi + SERVICE_DESU_STRUCTURE_MESSAGE.value0],	STATIC_EMPTY
	; mov	qword [rsi + SERVICE_DESU_STRUCTURE_MESSAGE.value1],	STATIC_EMPTY
	;
	; ; wyślij komunikat
...
.end:
	; zwolnij dostęp do listy obiektów
