...
LIBRARY_BOSU_ELEMENT_TASKBAR_FOREGROUND_color	equ	0x00AAAAAA
LIBRARY_BOSU_ELEMENT_TASKBAR_BACKGROUND_color	equ	0x00101010
LIBRARY_BOSU_ELEMENT_TASKBAR_BG_ACTIVE_color	equ	0x00282828
