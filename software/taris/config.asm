...
TARIS_FORESEE_WIDTH_pixel	equ	TARIS_WINDOW_WIDTH_pixel - TARIS_PLAYGROUND_WIDTH_pixel
TARIS_FORESEE_HEIGHT_pixel	equ	TARIS_WINDOW_WIDTH_pixel - TARIS_PLAYGROUND_WIDTH_pixel
TARIS_FORESEE_ALIGN_width	equ	0x04
TARIS_FORESEE_ALIGN_height	equ	0x0A

TARIS_WINDOW_WIDTH_pixel	equ	TARIS_PLAYGROUND_WIDTH_pixel + 48
