...
taris_block_next				dq	STATIC_EMPTY
taris_block_next_color				dd	STATIC_EMPTY
...
.element_button_close_end:			;-------------------------------
						; element "foresee"
						;-------------------------------
.element_foresee:				db	LIBRARY_BOSU_ELEMENT_TYPE_draw
						dw	.element_foresee_end - .element_foresee
						dw	TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_BOSU_HEADER_HEIGHT_pixel
						dw	TARIS_FORESEE_WIDTH_pixel
						dw	TARIS_FORESEE_HEIGHT_pixel
...
.element_label_points:				db	LIBRARY_BOSU_ELEMENT_TYPE_label
						...
						dw	TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_BOSU_HEADER_HEIGHT_pixel + (LIBRARY_FONT_HEIGHT_pixel << STATIC_MULTIPLE_BY_2_shift) + (((TARIS_BRICK_HEIGHT_pixel + TARIS_BRICK_PADDING_pixel) >> STATIC_DIVIDE_BY_2_shift) << STATIC_MULTIPLE_BY_4_shift)
...
.element_label_points_value:			db	LIBRARY_BOSU_ELEMENT_TYPE_label
						...
						dw	TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_BOSU_HEADER_HEIGHT_pixel + (LIBRARY_FONT_HEIGHT_pixel << STATIC_MULTIPLE_BY_4_shift) + (((TARIS_BRICK_HEIGHT_pixel + TARIS_BRICK_PADDING_pixel) >> STATIC_DIVIDE_BY_2_shift) << STATIC_MULTIPLE_BY_4_shift)
						dw	TARIS_WINDOW_WIDTH_pixel - TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_FONT_HEIGHT_pixel
						dq	STATIC_EMPTY
						db	LIBRARY_BOSU_ELEMENT_LABEL_FLAG_ALIGN_center	; domyślne wyrównanie tekstu
...
.element_label_level:				db	LIBRARY_BOSU_ELEMENT_TYPE_label
						...
						dw	TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_BOSU_HEADER_HEIGHT_pixel + (LIBRARY_FONT_HEIGHT_pixel * 0x06) + (((TARIS_BRICK_HEIGHT_pixel + TARIS_BRICK_PADDING_pixel) >> STATIC_DIVIDE_BY_2_shift) << STATIC_MULTIPLE_BY_4_shift)
						dw	TARIS_WINDOW_WIDTH_pixel - TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_FONT_HEIGHT_pixel
						dq	STATIC_EMPTY
						db	LIBRARY_BOSU_ELEMENT_LABEL_FLAG_ALIGN_center	; domyślne wyrównanie tekstu
...
.element_label_level_value:			db	LIBRARY_BOSU_ELEMENT_TYPE_label
						...
						dw	TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_BOSU_HEADER_HEIGHT_pixel + (LIBRARY_FONT_HEIGHT_pixel << STATIC_MULTIPLE_BY_8_shift) + (((TARIS_BRICK_HEIGHT_pixel + TARIS_BRICK_PADDING_pixel) >> STATIC_DIVIDE_BY_2_shift) << STATIC_MULTIPLE_BY_4_shift)
						dw	TARIS_WINDOW_WIDTH_pixel - TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_FONT_HEIGHT_pixel
						dq	STATIC_EMPTY
						db	LIBRARY_BOSU_ELEMENT_LABEL_FLAG_ALIGN_center	; domyślne wyrównanie tekstu
...
.element_label_lines:				db	LIBRARY_BOSU_ELEMENT_TYPE_label
						...
						dw	TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_BOSU_HEADER_HEIGHT_pixel + (LIBRARY_FONT_HEIGHT_pixel * 0x0A) + (((TARIS_BRICK_HEIGHT_pixel + TARIS_BRICK_PADDING_pixel) >> STATIC_DIVIDE_BY_2_shift) << STATIC_MULTIPLE_BY_4_shift)
						dw	TARIS_WINDOW_WIDTH_pixel - TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_FONT_HEIGHT_pixel
						dq	STATIC_EMPTY
						db	LIBRARY_BOSU_ELEMENT_LABEL_FLAG_ALIGN_center	; domyślne wyrównanie tekstu
...
.element_label_lines_value:			db	LIBRARY_BOSU_ELEMENT_TYPE_label
						...
						dw	TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_BOSU_HEADER_HEIGHT_pixel + (LIBRARY_FONT_HEIGHT_pixel * 0x0C) + (((TARIS_BRICK_HEIGHT_pixel + TARIS_BRICK_PADDING_pixel) >> STATIC_DIVIDE_BY_2_shift) << STATIC_MULTIPLE_BY_4_shift)
						dw	TARIS_WINDOW_WIDTH_pixel - TARIS_PLAYGROUND_WIDTH_pixel
						dw	LIBRARY_FONT_HEIGHT_pixel
						dq	STATIC_EMPTY
						db	LIBRARY_BOSU_ELEMENT_LABEL_FLAG_ALIGN_center	; domyślne wyrównanie tekstu
...
taris_bricks:					dq	0010011000100000000001110010000000100011001000000010011100000000b	; T
						...
						dq	0110011000000000011001100000000001100110000000000110011000000000b	; O
...
;===============================================================================
align	STATIC_QWORD_SIZE_byte,			db	STATIC_NOTHING
taris_rgl_playground_properties:		dw	TARIS_PLAYGROUND_WIDTH_pixel	; szerokość w pikselach
...
;===============================================================================
align	STATIC_QWORD_SIZE_byte,			db	STATIC_NOTHING
taris_rgl_foresee_properties:			dw	TARIS_FORESEE_WIDTH_pixel	; szerokość w pikselach
						dw	TARIS_FORESEE_HEIGHT_pixel	; wysokość w pikselach
						dq	STATIC_EMPTY	; wskaźnik do przestrzeni danych
						dq	(TARIS_FORESEE_WIDTH_pixel * TARIS_FORESEE_HEIGHT_pixel) << KERNEL_VIDEO_DEPTH_shift	; rozmiar przestrzeni w Bajtach
						dq	(TARIS_WINDOW_WIDTH_pixel + (LIBRARY_BOSU_WINDOW_BORDER_THICKNESS_pixel << STATIC_MULTIPLE_BY_2_shift)) << KERNEL_VIDEO_DEPTH_shift	; scanline w Bajtach
						dq	STATIC_EMPTY	; wskaźnik do przestrzeni tymczasowej (uzupełnia RGL)
						dd	STATIC_COLOR_BACKGROUND_default	; domyślny kolor tła
