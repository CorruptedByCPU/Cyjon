...
; DEBUG
;===============================================================================
; %define	DEBUG	; domyślnie powinien być wyłączony
; %define	TEST_TRANSPARENCY	; demo
...
SOFTWARE_STACK_LIMIT_page				equ	STATIC_PAGE_SIZE_byte >> STATIC_DIVIDE_BY_PAGE_shift
...
STATIC_MULTIPLE_BY_DWORD_shift				equ	STATIC_MULTIPLE_BY_4_shift
